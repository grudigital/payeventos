                                ...
                                <div class="card rounded-0 mb-0 p-2">
                                    <div class="card-header pt-50 pb-1">
                                        <div class="card-title">
                                            <h4 class="mb-0">Cadastro realizado com sucesso</h4>
                                        </div>
                                    </div>
                                            <p style="margin-top:20px;margin-bottom: 35px" class="px-2">Seu perfil está em processo de aprovação por nossa equipe de administradores. Aguarde que entraremos em contato em breve.</p>
                                    <a href="login.php"><button style="background-color: #267326 !important" type="submit"
                                            class="btn btn-primary float-right btn-inline mb-50">Voltar para o login
                                        </button></a>
                                </div>
                            </div>
                        </div>
