                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/kits_itens_adicionar.php">

                                        <div class='row'>
                                            <div class='col-xl-12 col-md-12 col-12 mb-1'>
                                                <fieldset class='form-group'>
                                                    <p>Item</p>
                                                    <input type='text' class='form-control' name='item' id='basicInput' placeholder="Item do kit">
                                                </fieldset>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <button style="float: right;" class="btn btn-primary waves-effect waves-light" type="submit">Salvar item</button>
                                            </div>
                                        </div>
                                    </form>
