                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="eventos_modalidades.php">Modalidades</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/eventos_modalidades_editar.php">

                                        <?php
                                        require("connections/conn.php");
                                        $pegaid = (int)$_GET['id'];

                                        $sql = "select * FROM eventos_modalidades where id = '$pegaid'";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<p>Modalidade</p>";
                                            echo "<input type='text' class='form-control' name='modalidade' id='basicInput' value='$row[modalidade]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
