        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Organizadores</h2>
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            $sql = "select u.id uid, u.nome unome, u.cpfcnpj ucpfcnpj, u.email uemail, u.senha usenha, u.perfil uperfil, u.idioma uidioma, u.imagem uimagem, u.whatsapp uwhatsapp, u.estado uestado, u.status ustatus, u.datacadastro udatacadastro, e.id eid, e.sigla esigla FROM usuarios as u inner join estados as e on u.estado = e.id where u.perfil = 2";
