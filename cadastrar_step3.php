                                ...
                                <div class="card rounded-0 mb-0 p-2">
                                    <div class="card-header pt-50 pb-1">
                                        <div class="card-title">
                                            <h4 class="mb-0">Criar conta (passo 3 de 3)</h4>
                                        </div>
                                    </div>
                                    <p class="px-2">Insira sua foto.</p>
                                    <div class="card-content">
                                        <div class="card-body pt-0">
                                            <form method="post" enctype="multipart/form-data"
                                                  action="functions/usuario_cadastrar3.php">
                                                <?php
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<input type='file' name='arquivo' class='form-control' placeholder='Foto' required>";
                                                    echo "<label for='inputName'>Foto</label>";
                                                    echo "</div>";
                                                ...
                                                <button style="background-color: #267326 !important;" type="submit"
                                                        class="btn btn-primary float-right btn-inline mb-50">Concluir cadastro
                                                </button>
                                            </form>
                                        </div>
                                    </div>
