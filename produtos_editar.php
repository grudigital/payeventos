                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/produtos_editar.php">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $pegaopcaoselecionada = "select * from produtos_categorias where id = '$row[categoria]'";
                                            $resultpegaopcaoselecionada = mysqli_query($conn, $pegaopcaoselecionada);

                                            $mostratodasopcoes = "select * from produtos_categorias";
                                            ...
                                            while ($rowpegaopcaoselecionada = mysqli_fetch_assoc($resultpegaopcaoselecionada)) {
                                                echo "<option style='background-color: #1B874B;color:#fff' selected value='$rowpegaopcaoselecionada[id]'>$rowpegaopcaoselecionada[categoria]</option>";
                                            }
                                            while ($rowmostratodasopcoes = mysqli_fetch_assoc($resultmostratodasopcoes)) {
                                                echo "<option value='$rowmostratodasopcoes[id]'>$rowmostratodasopcoes[categoria]</option>";
                                            }
                                            echo "</select>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            ...
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Preço</p>";
                                            echo "<input type='text' class='form-control' name='preco' id='preco' value='$row[preco]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
                                            ...
                                            echo "<div class='col-xl-12 col-md-12 col-12 mb-1'>";
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Cep de saída</p>";
                                            echo "<input type='text' class='form-control' onkeypress='mascara(this, '#####-###')' name='cepsaida' id='basicInput' value='$row[cepsaida]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
