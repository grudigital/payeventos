                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<li class='breadcrumb-item'><a href='eventos_categorias.php?id=$row[id]'>Categorias do evento</a></li>";
                            echo "<li class='breadcrumb-item active'>Editar categoria</li>";
                            echo "</ol>";
                            echo "</div>";
                        }
                        mysqli_close($conn);
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/eventos_categorias_editar.php">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<input type='hidden' name='evento' value='$row[evento]'>";
                                            ...
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Valor</p>";
                                            echo "<input type='text' class='form-control' id='preco' name='valor' id='basicInput' value='$row[valor]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
