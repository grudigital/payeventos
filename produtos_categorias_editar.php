                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="produtos_categorias.php">Produtos categorias</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/produtos_categorias_editar.php">

                                        <?php
                                        require("connections/conn.php");
                                        $pegaid = (int)$_GET['id'];

                                        $sql = "select * FROM produtos_categorias where id = '$pegaid'";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<p>Categoria</p>";
                                            echo "<input type='text' class='form-control' name='categoria' id='basicInput' value='$row[categoria]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
