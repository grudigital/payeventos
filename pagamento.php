        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Pagamento</h2>
...
<!--                                                        </div>-->
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/pagamento.php">

                                        <?php
                                        require("connections/conn.php");
                                        $sql = "select * FROM pagamento where id = 1";
                                        $result = mysqli_query($conn, $sql);

                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo "<h4 style='margin-bottom: 30px'>Mercado Pago ( vendas nacionais )</h4>";
                                            echo "<input type='hidden' name='id' value='$row[id]'>";
                                            echo "<div class='row'>";
                                            echo "<div class='col-xl-12 col-md-12 col-12 mb-1'>";
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Token de autenticação</p>";
                                            echo "<input type='text' class='form-control' name='mercadopago_token' id='basicInput' value='$row[mercadopago_token]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
                                            ...
                                            echo "<div class='col-xl-12 col-md-12 col-12 mb-1'>";
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Código de autorização</p>";
                                            echo "<input type='text' class='form-control' name='mercadopago_codigo' id='basicInput' value='$row[mercadopago_codigo]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";

                                            echo "<h4 style='margin-bottom: 30px'>Paypal ( vendas internacionais )</h4>";
                                            echo "<div class='row'>";
                                            echo "<div class='col-xl-12 col-md-12 col-12 mb-1'>";
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Token de autenticação</p>";
                                            echo "<input type='text' class='form-control' name='paypal_token' id='basicInput' value='$row[paypal_token]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
                                            ...
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Código de autorização</p>";
                                            echo "<input type='text' class='form-control' name='paypal_codigo' id='basicInput' value='$row[paypal_codigo]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <button style="float: right;" class="btn btn-primary waves-effect waves-light" type="submit">Atualizar dados</button>
                                            </div>
                                        </div>
                                    </form>
