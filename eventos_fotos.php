                    ...
                    <div class="col-md-12 col-12 ">
                        <div class="card">
                            <div style="float:left !important;">
                                ...
                                require("connections/conn.php");
                                $pegaid = (int)$_GET['id'];
                                $sql = "select e.id eid, e.imagem eimagem, ei.id eiid, ei.evento eievento, ei.imagem eiimagem FROM eventos as e inner join eventos_imagens as ei on e.id = ei.evento where ei.evento = '$pegaid'";
                                $result = mysqli_query($conn, $sql);

                                while ($row = mysqli_fetch_assoc($result)) {

                                    echo "<div style='margin-top: 20px; height: 300px; float: left; margin-bottom: 50px' class='col-md-4'><img style='width: 100%' src='uploads/eventos/$row[eiimagem]'>";
                                    echo "<div style='height: 20px; margin-top:30px; width: 100% '>";
                                    echo "<div class='row'>";


                                    if ($row['eiimagem'] != $row['eimagem']) {
                                        echo "<div class='col-md-7 col-7'>";
                                        echo "<a href='functions/eventos_imagem_tornar_capa.php?id=$row[eiid]'>";
                                        echo "<button type='button' style='width: 100%' class='btn btn-primary'>Tornar capa</button>";
                                        echo "</a>";
                                        echo "</div>";
                                        echo "<div class='col-md-5 col-5'>";
                                        echo "<a href='functions/eventos_imagem_excluir.php?id=$row[eiid]'>";
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<form method='post' enctype='multipart/form-data' action='functions/eventos_imagem_adicionar.php'>";
