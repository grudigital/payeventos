                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data"
                                          action="functions/produtos_adicionar.php">
                                        ...
                                        <div class='row'>
                                            <div class='col-xl-12 col-md-12 col-12 mb-1'>
                                                <fieldset class='form-group'>
                                                    <p>Cep de saída</p>
                                                    <input type='text' maxlength="9" onkeypress="mascara(this, '#####-###')" class='form-control' name='cepsaida'
                                                           id='basicInput' placeholder="Cep de saída">
                                                </fieldset>
                                            </div>
                                        </div>
