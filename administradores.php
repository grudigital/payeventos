                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            $sql = "select * FROM usuarios where perfil = 1";
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                if($row['status'] == 1){
                                                    echo "<td><a href='functions/administradores_status1.php?id=$row[id]'><button type='button' class='btn btn-success'>Ativado</button></a></td>";
                                                }else if($row['status'] == 2){
                                                    echo "<td><a href='functions/administradores_status2.php?id=$row[id]'><button type='button' class='btn btn-danger'>Desativado</button></a></td>";
                                                }
