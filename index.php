        ...
        <div class="content-body">
            ...
            card-img-right">
                                    ...
                                    <div class="text-center">
                                        <h1 class="mb-2 text-white">Bem vindo Felipe,</h1>
                                        <p class="m-auto w-75">Você tem <strong>57.6%</strong> more sales today. Check
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="mb-0">Últimos inscritos nos meus eventos</h4>
                            </div>
                            <div class="card-content">
