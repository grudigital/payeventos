                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<li class='breadcrumb-item active'>$row[titulo]</li>";
                            echo "<li class='breadcrumb-item active'>Categorias do evento</li>";
                            echo "</ol>";
                            echo "</div>";
                        }
                        mysqli_close($conn);
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            require("connections/conn.php");
                                            $pegaid = (int)$_GET['id'];
                                            $sql = "select * from eventos_categorias where evento = '$pegaid'";
                                            $result = mysqli_query($conn, $sql);
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                if($row['status'] == 1){
                                                    echo "<td><a href='functions/eventos_categorias_status1.php?id=$row[id]'><button type='button' class='btn btn-success'>Liberado</button></a></td>";
                                                }else if($row['status'] == 2){
                                                    echo "<td><a href='functions/eventos_categorias_status2.php?id=$row[id]'><button type='button' class='btn btn-danger'>Bloqueado</button></a></td>";
                                                }else if($row['status'] == 3){
                                                    echo "<td><a href='functions/eventos_categorias_status3.php?id=$row[id]'><button type='button' class='btn btn-dark'>Encerrado</button></a></td>";
                                                }

                                                echo "<td><a href='eventos_categorias_kits.php?id=$row[id]'><i class='feather icon-gift'></i></a></td>";
                                                echo "<td><a href='eventos_categorias_editar.php?id=$row[id]'><i class='feather icon-edit'></i></a></td>";
                                                echo "<td><a href='functions/eventos_categorias_excluir.php?id=$row[id]'><i class='feather icon-trash-2'></i></a></td>";
                                                echo "</tr>";
                                            }
                                            mysqli_close($conn);
                                            ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/eventos_categorias_adicionar.php">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result))
                                        {
                                            echo "<input type='hidden' name='evento' value='$pegaid'>";
                                        }
                                        mysqli_close($conn);
                                        ?>
                                        ...
                                        <div class='row'>
                                            <div class='col-xl-9 col-md-9 col-9 mb-1'>
                                                <fieldset class='form-group'>
                                                    <p>Título</p>
                                                    <input type='text' class='form-control' name='titulo' id='basicInput' placeholder="Título">
                                                </fieldset>
                                            </div>
                                            <div class='col-xl-3 col-md-3 col-3 mb-1'>
                                                <fieldset class='form-group'>
                                                    <p>Valor</p>
                                                    <input type='text' class='form-control' id="preco" name='valor' id='basicInput' placeholder="Valor">
                                                </fieldset>
                                            </div>
                                        </div>
