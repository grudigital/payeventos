                            ...
                            <div style="background-color:#33CC33 !important" class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2 py-1">
                                        ...
                                        <p class="px-2 mb-0">Insira seu e-mail abaixo e siga as instruções para gerar uma nova senha.</p>
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <div class="float-md-left d-block mb-1">
                                                    <a style="border-color: #267326; color: #267326" href="login.php" class="btn btn-outline-primary btn-block px-75">Ir para o login</a>
                                                </div>
                                                <div class="float-md-right d-block mb-1">
                                                    <a style="background-color: #267326 !important" href="#" class="btn btn-primary btn-block px-75">Recuperar senha</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
