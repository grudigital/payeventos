        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Itens</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="kits_itens.php">Kits</a></li>
                                <li class="breadcrumb-item active">Itens de kits</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            $sql = "select * FROM eventos_kit_item";
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<tr>";
                                                echo "<td>$row[item]</td>";
                                                echo "<td><a href='kits_itens_variacoes.php?id=$row[id]'><i class='feather icon-list'></i></a></td>";
                                                echo "<td><a href='kits_itens_editar.php?id=$row[id]'><i class='feather icon-edit'></i></a></td>";
                                                echo "<td><a href='functions/kits_itens_excluir.php?id=$row[id]'><i class='feather icon-trash-2'></i></a></td>";
                                                echo "</tr>";
