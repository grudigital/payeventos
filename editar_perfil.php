                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<form method='post' enctype='multipart/form-data' action='functions/editar_perfil.php'>";
                                        echo "<input type='hidden' name='id' value='$row[id]'>";
                                        echo "<div class='row'>";
                                        echo "<div class='col-xl-12 col-md-12 col-12 mb-1'>";
                                        echo "<fieldset class='form-group'>";
                                        echo "<p>Nome</p>";
                                        echo "<input type='text' class='form-control' name='nome' id='basicInput' value='$row[nome]'>";
                                        echo "</fieldset>";
                                        echo "</div>";
                                        echo "</div>";
                                        ...
                                        echo "<fieldset class='form-group'>";
                                        echo "<p>E-mail</p>";
                                        echo "<input type='email' class='form-control' name='email' id='basicInput' value='$row[email]'>";
                                        echo "</fieldset>";
                                        echo "</div>";
                                        echo "</div>";
                                        ...
                                        echo "<fieldset class='form-group'>";
                                        echo "<p>Whatsapp</p>";
                                        echo "<input type='text' class='form-control' onkeypress='mask(this, mphone);' onblur='mask(this, mphone);' name='whatsapp' id='basicInput' value='$row[whatsapp]'>";
                                        echo "</fieldset>";
                                        echo "</div>";
                                        echo "</div>";
                                        ...
                                        echo "<button style='float: right;' class='btn btn-primary waves-effect waves-light' type='submit'>Atualizar dados</button>";
                                        echo "</div>";
                                        echo "</div>";
                                        echo "</form>";
                                        ...
                                        echo "<form method='post' enctype='multipart/form-data' action='functions/editar_perfil_imagem.php'>";
                                        echo "<div style='margin-top: 30px; float:left; margin-bottom: 30px' class='col-lg-3 col-md-3'>";
                                        if($row['imagem'] == null){
                                            echo "<p style='margin-top: 42px'>Sem imagem</p>";
                                        }else{
                                            echo "<img style='width:100%' src='uploads/usuarios/$row[imagem]'>";
                                        }
                                        echo "</div>";


                                        echo "<div style='margin-top: 30px; float:left; margin-bottom: 30px' class='col-lg-9 col-md-9'>";
                                        echo "<fieldset class='form-group'>";
                                        echo "<p>Foto</p>";
                                        echo "<div class='custom-file'>";
                                        echo "<input type='hidden' name='id' value='$usuarioid'>";
                                        ...
                                        echo "<div class='row'>";
                                        echo "<div class='col-12'>";
                                        echo "<button style='float: right;' class='btn btn-primary waves-effect waves-light' type='submit'>Atualizar imagem</button>";
                                        echo "</div>";
                                        echo "</div>";
                                        echo "</form>";
