        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Categorias de produtos</h2>
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            $sql = "select * FROM produtos_categorias";
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td><a href='produtos_categorias_editar.php?id=$row[id]'><i class='feather icon-edit'></i></a></td>";
                                                echo "<td><a href='functions/produtos_categorias_excluir.php?id=$row[id]'><i class='feather icon-trash-2'></i></a></td>";
                                                echo "</tr>";
