        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Seo</h2>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/seo.php">
                                        ...
                                        echo "<div class='row'>";
                                            echo "<div class='col-xl-12 col-md-12 col-12 mb-1'>";
                                                echo "<fieldset class='form-group'>";
                                                    echo "<p>Código google analytics</p>";
                                                    echo "<input type='text' class='form-control' name='analytics' id='basicInput' value='$row[analytics]'>";
                                                    echo "</fieldset>";
                                                echo "</div>";
                                            echo "</div>";
                                        ...
                                        echo "<div class='row'>";
                                            echo "<div class='col-12'>";
                                                echo "<fieldset class='form-group'>";
                                                    echo "<textarea class='form-control' id='basicTextarea' name='description' rows='3'>$row[description]</textarea>";
                                                    echo "</fieldset>";
                                                echo "</div>";
                                            echo "</div>";
                                        echo "<p>Keywords</p>";
                                        echo "<div class='row'>";
                                            echo "<div class='col-12'>";
                                                echo "<fieldset class='form-group'>";
                                                    echo "<textarea class='form-control' id='basicTextarea' name='keywords' rows='3'>$row[keywords]</textarea>";
                                                    echo "</fieldset>";
                                                echo "</div>";
                                            echo "</div>";
                                        }
