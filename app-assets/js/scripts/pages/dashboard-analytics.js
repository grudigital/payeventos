...
$(window).on("load", function () {
  ...
  tour.addStep('step-2', {
    text: 'Veja tudo que acontece através de seus paineis exclusivos.',
  ...
  tour.addStep('step-5', {
    text: 'Você está pronto para utilizar a plataforma PayEvents!',
