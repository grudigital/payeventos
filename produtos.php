                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            $sql = "select p.id pid, p.titulo ptitulo, p.categoria pcategoria, p.responsavel presponsavel, p.status pstatus, pc.id pcid, pc.categoria pccategoria, u.id uid, u.nome unome FROM produtos as p inner join produtos_categorias as pc on p.categoria = pc.id left join usuarios as u on p.responsavel = u.id where p.status = '1' or p.status = '2' or p.status = '3' or p.status = '5'";
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                if($row['pstatus'] == 1){
                                                    echo "<td><a href='functions/produtos_status1.php?id=$row[pid]'><button type='button' class='btn btn-success'>Aprovado</button></a></td>";
                                                }else if($row['pstatus'] == 2){
                                                    echo "<td><a href='functions/produtos_status2.php?id=$row[pid]'><button type='button' class='btn btn-danger'>Reprovado</button></a></td>";
                                                }else if($row['pstatus'] == 3){
                                                    echo "<td><a href='functions/produtos_status3.php?id=$row[pid]'><button type='button' class='btn btn-dark'>Bloqueado</button></a></td>";
                                                }else if($row['pstatus'] == 5){
                                                    echo "<td><a href='functions/produtos_status4.php?id=$row[pid]'><button type='button' class='btn btn-warning'>Em análise</button></a></td>";
                                                }

                                                echo "<td><a href='produtos_editar.php?id=$row[pid]'><i class='feather icon-edit'></i></a></td>";
                                                echo "<td><a href='produtos_fotos.php?id=$row[pid]'><i class='feather icon-camera'></i></a></td>";
                                                echo "<td><a href='functions/produtos_excluir.php?id=$row[pid]'><i class='feather icon-trash-2'></i></a></td>";
