                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Modalidades de eventos</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td><a href='eventos_modalidades_editar.php?id=$row[id]'><i class='feather icon-edit'></i></a></td>";
                                                echo "<td><a href='functions/eventos_modalidades_excluir.php?id=$row[id]'><i class='feather icon-trash-2'></i></a></td>";
                                                echo "</tr>";
