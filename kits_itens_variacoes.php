            ...
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        $pegaid = (int)$_GET['id'];
                        $sql = "select * FROM eventos_kit_item where id = '$pegaid'";
                        $result = mysqli_query($conn, $sql);

                        while ($row = mysqli_fetch_assoc($result))
                        {
                           echo "<h2 class='content-header-title float-left mb-0'>$row[item]</h2>";
                        }
                        mysqli_close($conn);
                        ?>
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="kits_itens.php">Kits</a></li>
                                <li class="breadcrumb-item active">Variações de itens</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body card-dashboard">
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            require("connections/conn.php");
                                            $pegaid = (int)$_GET['id'];
                                            $sql = "select * FROM eventos_kit_variacoes where item = '$pegaid'";
                                            $result = mysqli_query($conn, $sql);

                                            while ($row = mysqli_fetch_assoc($result)) {

                                                echo "<tr>";
                                                echo "<td>$row[variacao]</td>";
                                                echo "<td><a href='kits_itens_variacoes_editar.php?id=$row[id]'><i class='feather icon-edit'></i></a></td>";
                                                echo "<td><a href='functions/kits_itens_variacoes_excluir.php?id=$row[id]'><i class='feather icon-trash-2'></i></a></td>";
                                                echo "</tr>";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                                                        <div class="card-header">
                                                            <h4 class="card-title">Adicionar variação</h4>
                                                        </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/kits_itens_variacoes_adicionar.php">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result))
                                        {
                                            echo "<input type='hidden' name='item' value='$pegaid'>";
                                        }
                                        mysqli_close($conn);
                                        ?>
                                        ...
                                        <div class='row'>
                                            <div class='col-xl-12 col-md-12 col-12 mb-1'>
                                                <fieldset class='form-group'>
                                                    ...
                                                    <input type='text' class='form-control' name='variacao' id='basicInput' placeholder="Título da variação">
                                                </fieldset>
                                            </div>
                                        </div>
