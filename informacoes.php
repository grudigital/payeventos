        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Informações</h2>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="functions/informacoes.php">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo "<h4 style='margin-bottom: 30px'>Dados de contato</h4>";
                                            echo "<input type='hidden' name='id' value='$row[id]'>";
                                            echo "<div class='row'>";
                                            echo "<div class='col-xl-12 col-md-12 col-12 mb-1'>";
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>E-mail</p>";
                                            echo "<input type='text' class='form-control' name='email' id='basicInput' value='$row[email]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
                                            ...
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Whatsapp</p>";
                                            echo "<input type='text' class='form-control' name='whatsapp' id='basicInput' value='$row[whatsapp]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";

                                            echo "<h4 style='margin-bottom: 30px'>Redes sociais</h4>";
                                            echo "<div class='row'>";
                                            echo "<div class='col-xl-12 col-md-12 col-12 mb-1'>";
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Facebook</p>";
                                            echo "<input type='text' class='form-control' name='facebook' id='basicInput' value='$row[facebook]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
                                            ...
                                            echo "<fieldset class='form-group'>";
                                            echo "<p>Instagram</p>";
                                            echo "<input type='text' class='form-control' name='instagram' id='basicInput' value='$row[instagram]'>";
                                            echo "</fieldset>";
                                            echo "</div>";
                                            echo "</div>";
